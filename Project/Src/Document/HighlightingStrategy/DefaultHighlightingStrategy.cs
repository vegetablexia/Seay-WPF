...
namespace ICSharpCode.TextEditor.Document
{
	public class DefaultHighlightingStrategy : IHighlightingStrategy
	{
		...
		public DefaultHighlightingStrategy(string name)
		{
			...
			// dark theme color environment
			Color defaultFg = Color.FromArgb(0xD4, 0xD4, 0xD4);
			Color defaultBg = Color.FromArgb(0x1E, 0x1E, 0x1E);

			digitColor      = new HighlightBackground(Color.FromArgb(0xB5, 0xCE, 0xA8), Color.Transparent, false, false);

			// set small 'default color environment'
			environmentColors["DefaultBackground"]= new HighlightBackground(defaultFg, defaultBg, false, false);
			environmentColors["Selection"]        = new HighlightColor(Color.White, Color.FromArgb(0x26, 0x4F, 0x78), false, false);
			environmentColors["VRuler"]           = new HighlightColor(Color.FromArgb(0x43, 0x43, 0x43), false, false);
			environmentColors["InvalidLines"]     = new HighlightColor(Color.Red, false, false);
			environmentColors["CaretMarker"]      = new HighlightColor(Color.FromArgb(0x51, 0x51, 0x51), false, false);
			environmentColors["LineNumbers"]      = new HighlightBackground(Color.FromArgb(0x85, 0x85, 0x85), Color.FromArgb(0x25, 0x25, 0x26), false, false);

			environmentColors["FoldLine"]         = new HighlightColor(Color.FromArgb(0x60, 0x60, 0x60), Color.FromArgb(0x25, 0x25, 0x26), false, false);
			environmentColors["FoldMarker"]       = new HighlightColor(Color.FromArgb(0x60, 0x60, 0x60), Color.FromArgb(0x25, 0x25, 0x26), false, false);
			environmentColors["SelectedFoldLine"] = new HighlightColor(defaultFg, false, false);
			environmentColors["EOLMarkers"]       = new HighlightColor(Color.FromArgb(0x43, 0x43, 0x43), false, false);
			environmentColors["SpaceMarkers"]     = new HighlightColor(Color.FromArgb(0x43, 0x43, 0x43), false, false);
			environmentColors["TabMarkers"]       = new HighlightColor(Color.FromArgb(0x43, 0x43, 0x43), false, false);
